package org.example.service.Humidity;
...
public class HumidityReadingService implements MqttCallbackExtended {
    ...
    public HumidityReadingService(MqttClient mqttClient, ReadingService readingService) {
    ...
    public void start() throws MqttException {
        ...
        System.out.println("Humidity service connected");
        handleConnect();
        mqttClient.subscribe("iot/HUMIDITY/+/telemetry");
    }
    ...
    public void connectComplete(boolean b, String s) {
        System.out.println("Humidity MQTT Connected to " + s);
    }
}
